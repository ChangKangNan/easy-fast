...
import sh.pd.lx.fast.easyfast.bean.ColumnInfo;
...
public class DbUtil {
    ...
    public void setPackPath(FileConfig conf, TableInfo tableInfo) {
        ...
        tableInfo.setPojoFilePath(javaBasePath + tableInfo.getPojoPackagePath().replace(".", separator)+"//pojo//" + separator + tableInfo.getPojoName() + ".java");
        tableInfo.setPojoFastPackagePath(javaBasePath + tableInfo.getPojoPackagePath().replace(".", separator)+"//pojo//fast//" + separator + tableInfo.getPojoName() + "Fast.java");
    }
